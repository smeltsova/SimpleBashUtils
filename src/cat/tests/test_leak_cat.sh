...
"-b -e -n -s -t -v ./tests/test_4_cat.txt"
"-b -e -n -s -t -v ./tests/test_5_cat.txt"
"-b -e -n -s -t -v ./tests/test_1_cat.txt ./tests/test_2_cat.txt 
./tests/test_3_cat.txt ./tests/test_4_cat.txt ./tests/test_5_cat.txt"
)
...
testing()
{
    ...
    leak=$(grep -a -A100000 leaks test_s21_cat.log)
    (( COUNTER++ ))
